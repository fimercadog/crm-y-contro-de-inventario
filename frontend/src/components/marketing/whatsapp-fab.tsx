...
/** Floating WhatsApp contact button — bottom-right, brand green, gentle pulse. */
export function WhatsappFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
    >
      <span
        aria-hidden
        className="absolute inset-0 -z-10 rounded-full bg-[#25D366] opacity-70 motion-safe:animate-ping"
      />
